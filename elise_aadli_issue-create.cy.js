...
describe('issue-create', () => {
  ...
  it('Should create an custom issue and validate it successfully', () => {
    ...
    cy.get('[data-testid="modal:issue-create"]').within(() => {
      ...
      cy.get('.ql-editor').type('My test description');
...
cy.get('[data-testid="board-list:backlog').should('be.visible').and('have.length', '1').within(() => {
  ...
  cy.get('[data-testid="list-issue"]')
      ...
      .find('p')
      .contains('Bug');
  //Assert that correct avatar and type icon are visible (Bug icon is not visible, Task icon is)
  ...
  it('Should create an issue with random data plugin and validate it successfully', () => {
    ...
    cy.get('[data-testid="modal:issue-create"]').within(() => {
      ...
      //open issue type dropdown and choose Task (cannot choose this option)
      cy.get('[data-testid="select:type"]').click();
      cy.get('[data-testid="select-option:Bug"]')
          .trigger('click');
